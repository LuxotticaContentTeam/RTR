    ...
    value: function load() {
      ...
      (0, _utils.eventCatcher)('ct_cm_rtr__loadData', function () {
        _this.RTR = new _main.default({
          ...
          showBackground: true,
          clearColor: '#D9CDC4',
          backgroundPath: '../static/images/SGH/bkg_rtr.jpg',
          //dev
          // backgroundPath:'../staticimages/SGH/bkg_rtr.jpg' //prod
 ...
 * @property {string} [hdr="../static/hdr/panorama_2_1.hdr"] - The path to the HDR environment map for real-time rendering.
...
var RTR = exports.default = /*#__PURE__*/function () {
  function RTR(_ref) {
    ...
    this.upc = upc;
    this.hdr = hdr || "../static/hdr/panorama_2_1.hdr"; // if not defined takes automatically the hdr in the static folder  and in prod https://media.BRAND.com/utilities/WebEFX/RTR/hdr/panorama_2_1.hdr 
    this.metadata = env ? {
      env: env
    } : {
      env: 'production'
    ...
    this.isReady = false;
    (0, _utils.loadScript)("../static/lib/v/".concat(version, "/main.js"), function () {
      _this.isReady = true;
    });
  }
  _createClass(RTR, [{
