  ...
  _createClass(Contents, [{
    ...
    value: function load() {
      ...
      (0, _utils.eventCatcher)('ct_cm_rtr__loadData', function () {
        _this.RTR = new _main.default({
          ...
          showBackground: true,
          clearColor: '#D9CDC4',
          backgroundPath: 'https://luxotticacontentteam.github.io/RTR/test/SGH_Homepage/static/RTRimages/SGH/bkg_rtr_full.jpg',
          //dev
          // backgroundPath:'https://luxotticacontentteam.github.io/RTR/test/SGH_Homepage/staticimages/SGH/bkg_rtr.jpg' //prod
    ...
    value: function eventHandler() {
      ...
      (0, _utils.eventCatcher)('ct_cm__RTR_rendered', function (_ref) {
        var id = _ref.id;
        if (id === _this2.RTR.selector) document.querySelector('.ct_cm__loader').classList.add('ct_cm__loaded');
      });
    }
  }]);
  return Contents;
 ...
 * @property {string} [hdr="https://luxotticacontentteam.github.io/RTR/test/SGH_Homepage/static/hdr/panorama_2_1.hdr"] - The path to the HDR environment map for real-time rendering.
...
var RTR = exports.default = /*#__PURE__*/function () {
  function RTR(_ref) {
    ...
    this.upc = upc;
    this.hdr = hdr || "https://luxotticacontentteam.github.io/RTR/test/SGH_Homepage/static/hdr/panorama_2_1.hdr"; // if not defined takes automatically the hdr in the static folder  and in prod https://media.BRAND.com/utilities/WebEFX/RTR/hdr/panorama_2_1.hdr 
    this.metadata = env ? {
      env: env
    } : {
      env: 'production'
    ...
    this.isReady = false;
    (0, _utils.loadScript)("https://luxotticacontentteam.github.io/RTR/test/SGH_Homepage/static/lib/v/".concat(version, "/main.js"), function () {
      _this.isReady = true;
    });
  }
  _createClass(RTR, [{
                  ...
                  onActions: function onActions(_ref2) {
                    ...
                    if (actions.rotate) {
                      ...
                      if (_this2.isRotating) {
                        ...
                        (0, _utils.eventDispatch)('ct_cm__RTR_endRotation', {
                          id: _this2.selector,
                          rotate: actions.rotate
                        });
                      }
...
exports.getData = exports.eventDispatch = exports.eventCatcher = exports.customLog = exports.clearData = exports.checkStore = exports.checkData = void 0;
